...
const Home = () => {
  return (
    <div className="h-screen overflow-y-scroll bg-gradient-to-r from-sky-500 to-indigo-500 px-4 py-8">
      <h1 className="text-3xl font-bold text-center text-white mb-8">
        The Power of Location: Unveiling Insights with Geospatial Data Analysis
      </h1>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-200">
          ...
          accidents) to areas (like city boundaries or ecological zones) or even
          3D data (like terrain or building heights). By visualizing this data
          on maps and other geographic contexts, we gain deeper insights into
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 text-lg text-gray-200">
          ...
          <p>
            Enhanced communication and storytelling through visually compelling
            maps and graphics.
          </p>
          <p>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 text-lg text-gray-200">
          ...
          <p>Web-based Mapping Platforms: Mymapindia, Mapbox, openstreetmap</p>
          <p>
